...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSub = (Button) findViewById(R.id.btmMinus); // -
        buttonMul = (Button) findViewById(R.id.btnMul); // *
        buttonDivision = (Button) findViewById(R.id.btnSlashBack); // "/"

        buttonC = (Button) findViewById(R.id.btnC);
        buttonEqual = (Button) findViewById(R.id.btnEqual);
        crunchifyEditText = (EditText ) findViewById(R.id.plain_text_input);
